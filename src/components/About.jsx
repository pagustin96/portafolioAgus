    ...
    <div className='about-container'>
        <header className='header-container'>
            <div className='header-wrapper'>
                ...
                <nav className='menu'>
                    <ul>
                        <li><a href='#about' className={`list-a ${activeSection === 'about' ? 'active' : ''}`} onClick={() => handleMenuClick('about')} ><hr className='hr-nav'/><span className='option-menu'>Sobre Mi</span></a></li>
        ...
        <div className='side-container'>
            ...
            <footer className='footer-container'>
                ...
                <p className='footer-p'>Loosely designed in Invision Studio and coded in Visual Studio Code by yours truly. 
